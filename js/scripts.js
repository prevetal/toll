...
document.addEventListener('DOMContentLoaded', function () {
	...
	// Карусель планировок
	const layoutsSliders = [],
		layouts = document.querySelectorAll('.layouts .swiper')

	layouts.forEach(function (el, i) {
		el.classList.add('layouts_s' + i)
		...
		layoutsSliders.push(new Swiper('.layouts_s' + i, options))
	})


	// Дизайн проект
	const designProjectsSliders = [],
		designProjects = document.querySelectorAll('.design_projects .swiper')

	designProjects.forEach(function (el, i) {
		el.classList.add('design_projects_s' + i)
		...
		designProjectsSliders.push(new Swiper('.design_projects_s' + i, options))
	})
	...
	// Всплывающее окно 3 вопросов
	var currentStep = 1

	$('#get_presentation .prev_btn').click(function(e) {
		e.preventDefault()

		$('#get_presentation .item').hide()

		currentStep--

		$('#get_presentation .item' + currentStep).fadeIn(300)
		$('#get_presentation .count .current').text(currentStep)
	})

	$('#get_presentation .next_btn').click(function(e) {
		e.preventDefault()
